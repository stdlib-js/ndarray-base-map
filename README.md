...
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/ndarray-base-map/tags). For example,

```javascript
map = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/ndarray-base-map@v0.1.0-umd/browser.js' )
```
...
[test-image]: https://github.com/stdlib-js/ndarray-base-map/actions/workflows/test.yml/badge.svg?branch=v0.1.0
[test-url]: https://github.com/stdlib-js/ndarray-base-map/actions/workflows/test.yml?query=branch:v0.1.0
